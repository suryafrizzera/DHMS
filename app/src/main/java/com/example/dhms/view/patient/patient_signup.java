...
public class patient_signup extends AppCompatActivity {
    ...
    CollectionReference patient = db.collection("patient");
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!TextUtils.equals(password.getText().toString().trim(),confirm_password.getText().toString().trim())){
                    Toast.makeText(patient_signup.this, "Enter the same password in confirm password",Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    auth.createUserWithEmailAndPassword(mail,password_text)
                            .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                                ...
                                public void onSuccess(AuthResult authResult) {
                                    Toast.makeText(patient_signup.this,"Registered Successfully",Toast.LENGTH_SHORT)
                                            .show();
                                    ...
                                    patient.document(mail).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            finish();
                                            startActivity(new Intent(patient_signup.this, patient_registration.class));
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(patient_signup.this,e.getMessage() + "Try again",Toast.LENGTH_SHORT)
                                                    .show();
                                        }
                                    });
                                }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.INVISIBLE);
                            signup.setVisibility(View.VISIBLE);
                            Toast.makeText(patient_signup.this,e.getMessage(),Toast.LENGTH_SHORT)
                                    .show();
                        }
                    });
                }
